fn main() {
    ...
    let (sum_of_nums, numbers) = sum(numbers); // variable name shadowing is possible, not really a good pattern perhaps... but it can be done
...
fn average(numbers: Vec<i64>) -> (i64, Vec<i64>) {
